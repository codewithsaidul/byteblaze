        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            >
              ...
              <li>
                <a href="#" className="text-lg font-semibold text-primary">Blog</a>
              </li>

              <li>
                <a href="#" className="text-lg font-semibold">Bookmarks</a>
              </li>
            </ul>
          </div>
          <a className="text-xl sm:text-2xl text-secondary font-extrabold">
